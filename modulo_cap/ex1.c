...
int main(int argc, char *argv[]){
	...
	/* get network number and mask associated with capture interfaceice */
	...
	if (handle == NULL) {
		fprintf(stderr, "Não foi possível capturar dados pela interface %s: %s\n", interface, errbuf);
		return(2);
	}
	...
	pcap_loop(handle, num_pacotes, got_packet, NULL);
